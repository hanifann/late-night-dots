 ...
 *6)emptycol         */
static const char *colors[] = {"#6b728c","#6b728c","#7a8c5c","#ff6666","#cc9933","#0a181e","#0a181e"};
...
static const uint8_t borders[] = {5,7,3,2};
...
static key keys[] = {
    ...
    // Start programs
    {  MOD |SHIFT,        XK_w,          start,             {.com = menucmd}},
    {  MOD , 		  XK_Return,	 start,		    {.com = terminal}},
    {  MOD , 		  XK_w,		 start,		    {.com = web}},
    {  MOD , 		  XK_r, 	 start, 	    {.com = rofi}},
